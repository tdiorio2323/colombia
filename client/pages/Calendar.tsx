    ...
    <div className="min-h-screen bg-background overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/calendar" className="text-primary transition-colors font-medium">Book Me</Link>
            </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto font-serif italic">
              Schedule your intimate moment with Colombia's most desired supermodel. 
              Choose your experience and let's create unforgettable memories together.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 relative">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url(https://cdn.builder.io/api/v1/image/assets%2Fed5382895c1f4487a68dd55afef3b83c%2F11628a736051448e9412cd3585b35f54?format=webp&width=800)'
          }}
        />
            ...
            <div className="grid lg:grid-cols-2 gap-12">
                ...
                <Card className="sexy-card p-8">
                  <CardHeader>
                    ...
                    <p className="text-muted-foreground font-serif italic">
                      Choose your preferred service, date, and time for our intimate encounter
                    </p>
                  </CardHeader>
                  <CardContent className="space-y-8">
                    ...
                    {/* Service Selection */}
                    <div>
                      <h3 className="text-xl font-display font-bold text-primary mb-4">Select Experience</h3>
                              ...
                              <div className="flex items-start space-x-3">
                                ...
                                <div className="flex-1">
                                  <div className="flex items-center justify-between mb-1">
                                    ...
                                    {service.sexy && <Flame className="h-3 w-3 text-primary" />}
                                  </div>
                                  <p className="text-xs text-muted-foreground mb-2">{service.description}</p>
                                  <div className="flex items-center justify-between">
                                    <span className="text-lg font-bold text-primary">{service.price}</span>
                                    <span className="text-xs text-gold">{service.duration}</span>
                                  </div>
                                </div>
                              </div>
                            </CardContent>
                    ...
                    {/* Date Selection */}
                    <div>
                      <h3 className="text-xl font-display font-bold text-primary mb-4">Choose Date</h3>
                        ...
                        {availableDates.map((dateInfo) => (
                          ...
                          >
                            <CardContent className="p-3 text-center">
                              <div className="text-xs font-medium text-muted-foreground">{dateInfo.day}</div>
                              <div className="text-sm font-bold">{new Date(dateInfo.date).getDate()}</div>
                            </CardContent>
                          </Card>
                        ))}
                      </div>
                    ...
                    {selectedDate && (
                      <div>
                        <h3 className="text-xl font-display font-bold text-primary mb-4">Select Time</h3>
                    ...
                    {/* Personal Details */}
                    <div>
                      <h3 className="text-xl font-display font-bold text-primary mb-4">Your Details</h3>
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
              ...
              <div className="space-y-8">
                ...
                <Card className="sexy-card p-8">
                  ...
                  <CardContent className="space-y-4 text-sm text-muted-foreground">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <span>Premium time slots include special extras and longer duration</span>
                    </div>
                    <div className="flex items-start space-x-3">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <span>Cancellations accepted up to 12 hours before appointment</span>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="sexy-card p-8 border-gold/50 bg-gradient-to-br from-gold/5 to-primary/5">
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-muted-foreground font-serif italic">
                      Upgrade to VIP for extended time, exclusive content, and special gifts
                    </p>
